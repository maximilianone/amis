...
<c:if test="${!empty sessionScope.admin_login}">
    ...
    <br><br><div style="padding:20px;margin-top:30px;height:200px;">
        <br><c:if test="${empty sessionScope.history}">
        ...
        <center>
            ...
            <table border="1">
                <tr>
                    ...
                    <th><h3>Change time</h3></th>
                    <th><h3>action</h3></th>
                </tr>
                <c:set var="count" value="1" scope="page" />
                <c:forEach items="${sessionScope.history}" var="objectList">
                    <tr>
                        <td><b>"${count}"</b></td>
                        ...
                        <td><c:out value="${objectList.changetime}" /></td>
                        <td><c:out value="${objectList.action}" /></td>
