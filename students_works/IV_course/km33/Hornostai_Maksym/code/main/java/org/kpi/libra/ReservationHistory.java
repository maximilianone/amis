...
public class ReservationHistory {
    ...
    public ReservationHistory(String fk_user_login, String fk_book_name, String fk_book_publisher, String status,
                              Date date_of_issue,Date date_of_return, Timestamp changetime, String action) {
